...
void showSynopsis()
{
  ...
  blk("  Update for the PEARL platform includes switch to get desired  ");
  blk("  heading from uSolarHeading instead of pHelmIvP when station-  ");
  blk("  keeping in order to maximize solar energy collection.         ");
}
...
void showHelpAndExit()
{
  blk("                                                           ");
  blu("========================================================== ");
  blu("Usage: pPearlPID file.moos [OPTIONS]                      ");
  blu("========================================================== ");
  blk("                                                           ");
  showSynopsis();
  blk("                                                           ");
...
void showExampleConfigAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("pPearlPID Example MOOS Configuration                           ");
  blu("=============================================================== ");
